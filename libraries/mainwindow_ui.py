...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionDetatch_All = QtGui.QAction(MainWindow)
        self.actionDetatch_All.setObjectName(_fromUtf8("actionDetatch_All"))
        self.menuFile.addAction(self.actionOpen_Folder)
        self.menuFile.addAction(self.actionQuit)
        self.menuPlot_positioning.addAction(self.actionRight)
        self.menuPlot_positioning.addAction(self.actionTop)
        self.menuPlot_positioning.addSeparator()
        self.menuPlot_positioning.addAction(self.actionDetatch_All)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionDetatch_All.setText(_translate("MainWindow", "Detatch All", None))
